...
# current issues with this program include incompatibility with destination
# plate location (D3) and temp_mod2.  Also need to figure out how to add 
# additional transfers and moves to destination plate after csv/cherrypicking
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    temp_labware1 = temp_mod1.load_labware(
    ...
    #temp_labware2 = temp_mod2.load_labware(
    ...
    temp_mod1.set_temperature(celsius=25)
    temp_mod2.set_temperature(celsius=25)
