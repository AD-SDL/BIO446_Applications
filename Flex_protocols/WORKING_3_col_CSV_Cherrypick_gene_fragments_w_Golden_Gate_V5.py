...
# Here we assume the file is already uploaded and parsed by the Opentrons app 
    ...
    # Load source and destination plates manually 
  ...
  for index, row in enumerate(well_data[1::]):
    # get source location from CSV
        source_well = row[0]
        source_location = protocol.deck[source_plate][source_well]
    ...
    # get destination location from CSV
        ...
        destination_location = protocol.deck[destination_plate][destination_well]
